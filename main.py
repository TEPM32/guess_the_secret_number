...
def index():
    # check if there is a cookie named secret_number
...
def result():
    ...
    if guess == secret_number:
        message = "You have guessed it correctly."
        ...
        message = "Your guess is incorrect. Please try something smaller."
        return render_template("result.html", message=message)
    elif guess < secret_number:
        message = "Your guess is incorrect. Please try something bigger."
        return render_template("result.html", message=message)
